...
public class KEAModelBuilder implements OptionHandler {
	...
	public KEAModelBuilder(final SKOSScheme scheme) {
	 ...
	 */
	public void setDisallowIPeriods(final boolean newdisallowIPeriods) {
	 ...
	 */
	public void setUseKFrequency(final boolean newuseKFrequency) {
	 ...
	 */
	public void buildModel(final Hashtable stems, final SKOSScheme schema,
			final String stopwordsPath, final SesameManager manager)
			throws Exception {
		...
		// }
		m_KEAFilter.loadThesaurus(getStemmer(), getStopwords(), vocabulary);
		...
		m_KEAFilter.batchFinished(vocabulary);
	 ...
	 */
	public static void main(final String[] ops) throws RepositoryException {
