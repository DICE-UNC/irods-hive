...
/**
 * This class loads several vocabularies and models simultaneously. Then all of
 * them can be applied to generate topics from a given text.
 * 
 * @author alyona
 * 
 */
public class MauiWrapperFactory {
	...
	/**
	 * Constructor - directory, where data is stored (should be similar
	 * structure as the main directory of Maui1.2, i.e. contain
	 * data/vocabularies, data/models, and data/stopwords).
	 * 
	 * @param dataDirectory
	 */
	public MauiWrapperFactory(final String dataDirectory) {
	 ...
	 * 
	 * @param input
	 *            - input text or a path to a file with text input
	 * @param isaFile
	 *            - whether the input is a file or a text string
	 * @param numberOfTopics
	 *            - how many topics should be extracted
	 * @param domain
	 *            - what is the domain (agriculture, physics, medicine, general)
	 * @return
	 * @throws Exception
	 */
	private ArrayList<String> extractTopics(final String input,
			final boolean isaFile, final int numberOfTopics, final String domain)
			throws Exception {
	...
	/**
	 * Main method for testing MauiWrapperFactory Add the path to a text file as
	...
	public static void main(final String[] args) {
		...
		try {
			...
			ArrayList<String> keywords = factory.extractTopics(filePath, true,
					10, "agriculture");
