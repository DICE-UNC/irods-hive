...
/**
 * 
 * PorterStemmer.java Programmer: John Keyes (keyeg@ils.unc.edu) Last Modified:
 * January 3, 1998 This class implements the PORTER stemming algorithm, which is
 * fully described in "An algorithm for suffix stripping", M.F. Porter (1980),
	...
	protected String step1b2(final String str) {
		...
		if (str.endsWith("at") || str.endsWith("bl") || str.endsWith("iz")) {
			return str + "e";
				...
				&& (!(str.endsWith("l") || str.endsWith("s") || str
						.endsWith("z")))) {
			return str.substring(0, str.length() - 1);
