...
public class JenaHiveSPARQLServiceImplTest {

	private static Properties testingProperties = new Properties();
	private static org.irods.jargon.testutils.TestingPropertiesHelper testingPropertiesHelper = new TestingPropertiesHelper();
	public static final String IRODS_TEST_SUBDIR_PATH = "JenaHiveSPARQLServiceImplTest";
	...
	public void testQuery() throws Exception {
		...
		Assert.assertNotNull("no result model", result);

	}

	@Test(expected = HiveQueryException.class)
	public void testBogusQuery() throws Exception {
	...
	@Test
	public void testQueryReturnJSON() throws Exception {
		String sparql = LocalFileUtils
				.getClasspathResourceFileAsString("/sparql/sparql1.txt");
		...
		Assert.assertNotNull("no result", json);
		Assert.assertFalse("empty result", json.isEmpty());
	}
