...
public class IrodsJenaModelQueryImpl implements IrodsJenaModelQuery {
	 ...
	 * @param jenaModel {@link OntModel} that is opened, and will be used for any queries
	 */
	...
	/* (non-Javadoc)
	 * @see org.irods.jargon.hive.external.indexer.modelservice.IrodsJenaModelQuery#queryAllOnVocabularyTerm(java.lang.String)
	 */
	@Override
	public ResultSet queryAllOnVocabularyTerm(
			final String vocabularyUri)
		...
		try {
			...
			String template = SPARQLTemplateUtils.getRawSPARQLTemplate("/sqarql-template/queryAllForTerm.txt");
			
			String query = SPARQLTemplateUtils
					.getSPARQLTemplateAndSubstituteValues(template,
							params);
	...
	/* (non-Javadoc)
	 * @see org.irods.jargon.hive.external.indexer.modelservice.IrodsJenaModelQuery#queryAndReturnJSONAsString(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.irods.jargon.hive.external.indexer.modelservice.IrodsJenaModelQuery#queryAndReturnResultSet(java.lang.String)
	 */
